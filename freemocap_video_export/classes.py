...
class vc_image:
    ...
    def add_component(self,
        ...
        frame_subsection = frame[self.image_position[1]:self.image_position[1] + self.image_height,
        ...
        frame[self.image_position[1]:self.image_position[1] + self.image_height,
    ...
    def add_component(self,
        ...
        fig, ax = plt.subplots(figsize=(6.4,
                                        6.4 * frame_info.height * visual_components['vc_plot_com_bos']['height_pct'] / (
                                                    frame_info.width * visual_components['vc_plot_com_bos'][
                                                'width_pct'])))
        ...
        # Get the frame subsection
        frame_subsection = frame[plot_top_left_corner[1]:plot_top_left_corner[1] + img_resized.shape[0],
        ...
        # Append the composite to the frame
        frame[plot_top_left_corner[1]:plot_top_left_corner[1] + img_resized.shape[0],

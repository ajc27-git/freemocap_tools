...
def fbx_animations_do_blender3(scene_data, ref_id, f_start, f_end, start_zero, objects=None, force_keep=False):
    """
...
def fbx_data_armature_elements_blender3(root, arm_obj, scene_data):
    """
    Write:
...
def fbx_data_object_elements_blender3(root, ob_obj, scene_data):
    """
...
def fbx_data_bindpose_element_blender3(root, me_obj, me, scene_data, arm_obj=None, mat_world_arm=None, bones=[]):
    """
